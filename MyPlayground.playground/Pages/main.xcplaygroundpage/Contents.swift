...
let name1 = "Pink Pnather"
var name2 = "Ninja Turtle"
name2 = "Donald Trump"
...
func favoriteBand (nameOfBand: String, num: Int){
...
func nameOfcharacter (name: String)->String{
    let str =  "To infinity and beyond, \(name)!"
    return str
}
